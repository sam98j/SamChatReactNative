  ...
  return (
    <View>
      ...
      <View style={styles.discriptionTextContainer}>
        <Text style={[styles.fontFamily, styles.welcomeText]}>{i18n.t('onboarding.home.welcome')}</Text>
        <Text style={[styles.fontFamily, styles.discriptionText]}>{i18n.t('onboarding.home.description')}</Text>
      </View>
    </View>
  );
};
